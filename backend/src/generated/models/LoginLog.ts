...
export type LoginLogWhereInput = {
  ...
  deviceId?: Prisma.StringFilter<"LoginLog"> | string
...
export type LoginLogScalarWhereWithAggregatesInput = {
  ...
  deviceId?: Prisma.StringWithAggregatesFilter<"LoginLog"> | string
...
export type LoginLogOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "userId" | "deviceId" | "ipAddress" | "createdAt" | "updatedAt", ExtArgs["result"]["loginLog"]>
...
export interface LoginLogFieldRefs {
  ...
  readonly deviceId: Prisma.FieldRef<"LoginLog", 'String'>
